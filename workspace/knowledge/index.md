...
- [outcome-lock](concepts/outcome-lock.md)

## ZUAEF-ASHARE-001 / zuaef-quant（A 股量化决策）

- [zuaef-quant-overview](concepts/zuaef-quant-overview.md) — 定位、架构、权威边界、证明状态
- [quant-data-plane](concepts/quant-data-plane.md) — akshare 数据面、缓存布局、universe 定制、限制
- [quant-strategy-mechanics](concepts/quant-strategy-mechanics.md) — StrategySpec、gen1 基线、冻结的 DEMO 策略、进化记录
