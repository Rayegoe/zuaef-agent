# Vendored from microsoft/qlib commit 79633dd9506ea689e5400dea0197717b5b3d74b7
# (audited in ZUAEF-ASHARE-001 12_UPSTREAM_LOCK.toml). MIT License, (c) Microsoft.
# Upstream scripts/ is not shipped in the pyqlib wheel; this is the canonical
# CSV->bin ingestion path used unchanged for P1 qlib data prep.
