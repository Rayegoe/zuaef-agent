...
Production authority lives here (P5.9-B).  Do not merge this public-event
material surface with market-wide context state (P5.9 section 9).
...
Runs in the .venv-quant side environment (akshare lives there) via
``python -m zuaef_quant.market_intel``; output is one JSON line on stdout.
"""
